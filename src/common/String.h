...
public:
	...
	inline bool BeginsWith(ByteString const &other) const { return other.size() <= size() && !super::compare(0, other.size(), other); }
	inline bool EndsWith(ByteString const &other) const { return other.size() <= size() && !super::compare(size() - other.size(), other.size(), other); }
...
public:
	...
	inline bool BeginsWith(String const &other) const { return other.size() <= size() && !super::compare(0, other.size(), other); }
	inline bool EndsWith(String const &other) const { return other.size() <= size() && !super::compare(size() - other.size(), other.size(), other); }
